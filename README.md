...
> **Fork of the [Model Context Protocol TypeScript SDK](https://github.com/modelcontextprotocol/typescript-sdk)** with Odel-specific extensions for the AI module marketplace.
