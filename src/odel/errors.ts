...
export class ModuleError extends Error {
	...
	constructor(
		...
		if (typeof (Error as typeof globalThis.Error & { captureStackTrace?: (target: object, constructor: unknown) => void }).captureStackTrace === 'function') {
			(Error as typeof globalThis.Error & { captureStackTrace: (target: object, constructor: unknown) => void }).captureStackTrace(this, ModuleError);
		}
	}
